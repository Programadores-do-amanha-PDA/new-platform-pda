...
export const ProfileDataTabs = ({ currentUser, onUpdateUser }: Readonly<ProfileDataTabsProps>): React.JSX.Element => {
    ...
    const onSubmit = async (data: ProfileFormSchemaT): Promise<void> => {
        try {
            ...
            const userUpdateResponse = await updateAuthUser({ updates: userData });
