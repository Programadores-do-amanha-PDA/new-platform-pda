...
export const createClassroomProjectCorrection = async (
    ...
    try {
        ...
        const { data, error } = await supabase.from("classroom_project_corrections").insert([correctionData]).select().single();
...
export const getAllCorrectionsByProjectId = async (projectId: string): Promise<ClassroomProjectCorrection[] | null> => {
    try {
        const supabase = await createClient();
...
export const getAllCorrectionsByDeliveryId = async (deliveryId: string): Promise<ClassroomProjectCorrection[] | null> => {
    try {
        const supabase = await createClient();
        const { data, error } = await supabase
            .from("classroom_project_corrections")
...
export const getAllCorrectionsByClassroomId = async (classroomId: string): Promise<ClassroomProjectCorrection[] | null> => {
    try {
        const supabase = await createClient();
        const { data, error } = await supabase
            .from("classroom_project_corrections")
...
export const getClassroomProjectCorrectionById = async (id: string): Promise<ClassroomProjectCorrection | null> => {
    try {
        const supabase = await createClient();
        const { data, error } = await supabase.from("classroom_project_corrections").select("*").eq("id", id).single();
...
export const deleteCorrectionById = async (id: string): Promise<boolean> => {
    try {
        const supabase = await createClient();
        const { error } = await supabase.from("classroom_project_corrections").delete().eq("id", id);
