...
import { ProjectStatusRendererPropsT } from "../../types/projects/project-card";
import { analyzeDeliveryStatus } from "../../utils/deliveries/delivery-status";
...
export const ProjectStatusRenderer: React.FC<ProjectStatusRendererPropsT> = ({
  ...
  switch (deliveryStatus.status) {
    ...
    case "delivered-editable":
      return (
        <div className="flex flex-col items-start gap-4 bg-blue-50 dark:bg-blue-950/20 p-4 border border-blue-200 dark:border-blue-800 rounded-xl">
          ...
          <Button
            ...
            className="hover:bg-blue-100 dark:hover:bg-blue-950/30 border-blue-300 dark:border-blue-700 font-semibold text-blue-700 dark:text-blue-300"
          >
            Editar entrega
          </Button>
        </div>
    ...
    case "can-recover":
      return (
        <div className="flex flex-col items-start gap-4 p-4 border border-amber-400 dark:border-amber-800 rounded-xl">
          <div className="flex flex-col gap-2">
            <p
              className="font-semibold text-amber-700 dark:text-amber-300 text-sm"
              role="status"
              aria-live="polite"
            >
          ...
          <Button
            ...
            className="hover:bg-amber-100 dark:hover:bg-amber-950/30 border-amber-300 dark:border-amber-700 font-bold text-amber-700 dark:text-amber-300"
          >
    ...
    case "recovery-delivered-editable":
      return (
        <div className="flex flex-col items-start gap-4 bg-amber-50 dark:bg-amber-950/20 p-4 border border-amber-200 dark:border-amber-800 rounded-xl">
          <div className="flex flex-col gap-2">
            <p
              className="font-semibold text-amber-700 dark:text-amber-300 text-sm"
              role="status"
          ...
          <Button
            ...
            className="hover:bg-amber-100 dark:hover:bg-amber-950/30 border-amber-300 dark:border-amber-700 font-semibold text-amber-700 dark:text-amber-300"
          >
    ...
    case "recovery-delivered":
      return (
        <div className="flex flex-col items-start gap-4 dark:bg-blue-950/20 p-4 border border-amber-500 dark:border-amber-800 rounded-xl">
          <div className="flex flex-col gap-2">
            <Badge
              variant="secondary"
              className="w-fit"
    ...
    case "corrected":
      return (
        <div className="flex flex-col items-start gap-4 bg-emerald-50 dark:bg-emerald-950/20 p-4 border border-emerald-200 dark:border-emerald-800 rounded-xl">
          <div className="flex flex-col gap-2">
            <p
              className="font-semibold text-emerald-700 dark:text-emerald-300 text-sm"
              role="status"
              aria-live="polite"
            >
              Projeto corrigido
