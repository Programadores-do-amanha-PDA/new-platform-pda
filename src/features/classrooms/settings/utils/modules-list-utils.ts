 ...
 */
export const handleModuleEdit = (module: ClassModules, setCurrentModule: (module: ClassModules | null) => void): void => {
 ...
 * @param setCurrentModule - State setter function
 */
export const handleModuleClear = (setCurrentModule: (module: ClassModules | null) => void): void => {
 ...
 */
export const isModulesListEmpty = (modules: ClassModules[]): boolean => {
 ...
 */
export const getModulesCountDescription = (modules: ClassModules[]): string => {
