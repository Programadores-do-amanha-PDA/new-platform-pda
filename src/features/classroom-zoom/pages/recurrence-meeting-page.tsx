...
type MeetingPastInstance = ZoomMeetingPastInstance & {
  ...
  updatePastInstanceById: (
    id: string,
    updates: Partial<ZoomMeetingPastInstance>
  ) => Promise<boolean>;
  ...
  },
  {
    ...
    cell: ({ row }: { row: { original: MeetingPastInstance } }) => (
      <div
        ...
        className="flex justify-center items-center border-b w-full h-full"
      >
        <DropdownMenu>
          <DropdownMenuTrigger>
...
export default function ZoomRecurrenceMeetingPage({
  ...
  const [selectedInstancie, setSelectedInstancie] =
    useState<ZoomMeetingPastInstance | null>(null);
