import { buildUserUpdateData, isEmailChanged } from "../utils/profile-form-utils";
...
describe("profile-form-utils", () => {
    ...
    describe("isEmailChanged", () => {
        it("should return true when email is different", () => {
            const result = isEmailChanged("newemail@example.com", "john@example.com");

            expect(result).toBe(true);
        });

        it("should return false when email is the same", () => {
            const result = isEmailChanged("john@example.com", "john@example.com");

            expect(result).toBe(false);
        });

        it("should return true when current email is undefined", () => {
            const result = isEmailChanged("john@example.com", undefined);

            expect(result).toBe(true);
        });

        it("should return true when both emails are different and current is undefined", () => {
            const result = isEmailChanged("newemail@example.com", undefined);
