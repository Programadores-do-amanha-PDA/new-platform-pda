        ...
        cell: ({ row }) => (
            <div className="w-full min-h-[57px] flex flex-row gap-2 justify-start items-center px-2 border-r border-b bg-background group-hover/row:bg-muted/50!">
                ...
                <div className="w-full flex flex-col justify-center lowercase truncate">
                    <p className="text-sm font-bold capitalize">{row.getValue<ProfileT>("profile").full_name}</p>
                ...
                return (
                    <div className="w-[430px] h-[141px] p-0! flex flex-col border-r-2 border-b">
                        ...
                        <div className="w-full h-8 flex justify-center items-center border-b">
                            <p className="text-sm font-bold">Geral: {generalPercentage.toFixed(1)}%</p>
                        </div>
                        ...
                        <div className="w-full h-8 flex border-b">
                            ...
                            <div className="flex-1 h-8 flex justify-center items-center border-r px-1">
                                <p className="text-xs font-semibold text-center">Facilitação</p>
                            </div>
                            <div className="flex-1 h-8 flex justify-center items-center px-1">
                                <p className="text-xs font-semibold text-center">Auto-desenvolvimento</p>
                            </div>
                        </div>
                        ...
                        <div className="w-full h-8 flex">
                            <div className="flex-1 h-8 flex justify-center items-center border-r px-1">
                                <p className="text-xs font-bold text-blue-600">{contentPercentage.toFixed(1)}%</p>
                            </div>
                            <div className="flex-1 h-8 flex justify-center items-center border-r px-1">
                                <p className="text-xs font-bold text-purple-600">{facilitationPercentage.toFixed(1)}%</p>
                            </div>
                            <div className="flex-1 h-8 flex justify-center items-center px-1">
                                <p className="text-xs font-bold text-orange-600">{selfDevPercentage.toFixed(1)}%</p>
                            </div>
                        </div>
                    </div>
                );
                ...
                return (
                    <div className="w-[430px] min-h-[57px] flex border-b border-r-2">
                        <div className="flex-1 flex justify-center items-center border-r px-1 py-2">
                            <span className="text-xs text-center capitalize truncate" title={contentAnswer}>
                                {contentAnswer}
                            </span>
                        </div>
                        <div className="flex-1 flex justify-center  items-center border-r px-1 py-2">
                            <span className="text-xs text-center capitalize truncate" title={facilitationAnswer}>
                                {facilitationAnswer}
                            </span>
                        </div>
                        <div className="flex-1 flex justify-center items-center px-1 py-2">
                            <span className="text-xs text-center capitalize truncate" title={selfDevAnswer}>
                                {selfDevAnswer}
                            </span>
                        </div>
                    </div>
                ...
                <Table className="w-max">
                    <TableHeader className="bg-sidebar border-0! sticky top-0 left-0 right-0 z-20 overflow-hidden">
                        {table.getHeaderGroups().map((headerGroup) => (
                            <TableRow key={headerGroup.id} className="max-w-[155px]! border-0! !p-0">
