export interface CoodeshAttemptResultsRow {
  id: string;
...
export interface CoodeshAttemptIntegrityRow {
  timestamp: string;
  participationId: string;
  assessmentName: string;
  participant: string;
...
export interface CoodeshAttemptActionPlanRow {
  id: string;
  participationId: string;
  assessmentName: string;
  participant: string;
...
export interface CoodeshAttemptParticipantData {
  email: string;
  name: string;
  results: CoodeshAttemptResultsRow[];
