...
import { ZoomMeetingPastInstance } from "@/features/dashboard/classrooms/classroom/integrations/zoom/types";
...
const createPastInstance = async (
  pastInstanceData: Partial<Omit<ZoomMeetingPastInstance, "id | create_at">>
) => {
  try {
    const supabase = await createClient();
...
const updatePastInstanceById = async (
  ...
  updates: Partial<Omit<ZoomMeetingPastInstance, "id | create_at">>
) => {
  try {
    const supabase = await createClient();
    const { data, error } = await supabase
...
const createMultiplePastInstances = async (
  pastInstancesData: Partial<Omit<ZoomMeetingPastInstance, "id | create_at">>[]
) => {
  try {
    const supabase = await createClient();
...
const upsertMultiplePastInstances = async (
  ...
  pastInstancesData: Partial<
    Omit<ZoomMeetingPastInstance, "id | create_at">
  >[],
