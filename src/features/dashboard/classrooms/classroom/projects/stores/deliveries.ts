...
import {
  ...
  deleteDeliveryById,
} from "@/features/dashboard/classrooms/classroom/projects/actions/deliveries";
import { ClassroomProjectDelivery } from "../types";
...
interface DeliveryActions {
  ...
  updateDelivery: (
    id: string,
    deliveryData: Partial<ClassroomProjectDelivery>,
    classroomId: string
  ) => Promise<boolean>;
