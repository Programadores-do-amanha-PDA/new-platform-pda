import { ZoomAccountT, ZoomMeetingPastInstance } from ".";
...
export type ZoomMeetingWithPastInstancies = ZoomMeeting & {
  past_instances: ZoomMeetingPastInstance[];
};
...
export interface ZoomMeetingActions {
  setMeetings: (meetings: ZoomMeeting[]) => void;
  getAllMeetings: (classroomId: string) => Promise<boolean>;
  getMeetingById: (meetingId: string) => Promise<ZoomMeeting | boolean>;
  createMeeting: (
  ...
  handleNonRecurrentMeetingUpdate: (
    meeting: ZoomMeetingActionsMeetingPickT,
    account: ZoomMeetingActionsAccountPickT,
    updatedMeetingData: Partial<ZoomMeeting>
  ) => Promise<void>;
  processNewPastInstances: (
    meeting: ZoomMeetingActionsMeetingPickT,
    account: ZoomMeetingActionsAccountPickT,
    pastInstances: Partial<ZoomMeetingPastInstance>[]
  ) => Promise<void>;
  ...
  fetchPastInstancesData: (
    account: ZoomMeetingActionsAccountPickT,
    pastInstances: Partial<ZoomMeetingPastInstance>[]
  ) => Promise<ZoomMeetingPastInstance[] | null>;
