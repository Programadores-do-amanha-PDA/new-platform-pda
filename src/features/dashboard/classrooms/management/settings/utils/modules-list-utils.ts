 ...
 */
export const handleModuleEdit = (module: Modules, setCurrentModule: (module: Modules | null) => void): void => {
 ...
 * @param setCurrentModule - State setter function
 */
export const handleModuleClear = (setCurrentModule: (module: Modules | null) => void): void => {
 ...
 */
export const isModulesListEmpty = (modules: Modules[]): boolean => {
 ...
 */
export const getModulesCountDescription = (modules: Modules[]): string => {
