...
export const getSettingByClassroomId = async ({ classroomId }: { classroomId: string }): Promise<Setting[] | null> => {
    try {
...
export const createSetting = async ({
    ...
    settingData: Partial<Omit<Setting, "id" | "created_at">>;
    ...
    try {
        ...
        log.info({ settingData, operation: "createSetting" }, "Setting created successfully");
...
export const updateSettingById = async ({
    ...
    try {
        ...
        log.info({ settingId: id, updates, operation: "updateSettingById" }, "Setting updated successfully");
