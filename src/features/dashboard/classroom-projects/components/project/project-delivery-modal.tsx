            ...
            <section ref={membersRef} className="flex flex-col">
              ...
              <div className="space-y-4 mt-2">
                <p className="text-sm text-primary-foreground font-medium">
                  Membro responsável pela entrega
                </p>
            ...
            <div className="space-y-4">
              ...
              {links.length > 0 && (
                <div className="space-y-4 flex flex-col w-full">
                  ...
                  <div className="w-full space-y-2 flex flex-col overflow-hidden">
                    {links.map((link, index) => (
                      <div
                        key={index}
                        className="w-full flex items-center justify-between p-2 border rounded-lg truncate"
                      >
                        <p className="text-sm mr-2">{link.url}</p>
                        <Button
                          type="button"
                          variant="destructive"
                          size="icon-sm"
