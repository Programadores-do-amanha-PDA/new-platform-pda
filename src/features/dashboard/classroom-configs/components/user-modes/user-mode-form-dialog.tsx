...
import { UserModeFormDialogPropsT } from "../../types/user-mode/user-mode";
import { UserModeFormSchema, UserModeFormSchemaT } from "../../utils/user-mode-validation";
import {
    processColorValue,
...
import { getAllFeaturesRules } from "../../utils";
 ...
 */
const UserModeFormDialog = ({ configId, currentUserMode, trigger, onClose }: UserModeFormDialogPropsT): JSX.Element => {
                            ...
                            <Table className="w-full h-max p-0! border-0!">
                                <TableHeader className="p-0! border-0!">
                                    <TableRow className="p-0! border-0!">
                                        ...
                                        <TableHead className="w-[100px] text-center p-0! border-0!" scope="col">
