...
import { AuthUserWithProfileT, SidebarDataT, ClassroomT, ClassroomCoodeshAssessmentT } from "@/types";
...
export const generateSidebarConfig = (user: AuthUserWithProfileT, classrooms: ClassroomT[]): SidebarDataT => {
    return {
        user,
        team: {
            name: "Administrador",
...
export const generatePathLabels = (
    ...
    if (classrooms.length > 0) {
        classrooms.forEach((classroom) => (classroomLabels[classroom.id] = classroom.name));
    }
    ...
    if (projects.length > 0) {
        projects.forEach((project) => (classroomProjects[project.id] = project.title));
    }
...
export const generateNoAccessSidebarConfig = (user: AuthUserWithProfileT): SidebarDataT => {
