...
export const useUserClassroomsStore = create<UserClassroomsState & UserClassroomsActions>()(
    devtools(
        (set) => ({
            ...initialState,
            ...
            handleInsertUserClassrooms: async (usersClassrooms: UserClassroomT[]) => {
                try {
                    set({ loading: true });
            ...
            handleDeleteUserClassroom: async (
                userId: string,
                classroomsIds: string[]
            ) => {
                try {
