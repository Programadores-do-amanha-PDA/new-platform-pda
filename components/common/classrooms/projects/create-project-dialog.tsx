...
const CreateProjectDialog = ({
  ...
  const {
    classroomsStack: {
      projects: { handleCreateClassroomProject, handleUpdateClassroomProject },
    },
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!currentProject?.id) {
        await handleCreateClassroomProject({
          title,
          module,
          classroom_id,
          project_type: type,
        ...
        await handleUpdateClassroomProject(currentProject.id, updates);
        return;
      }
    } catch {
      toast.error(
